          ...
          <form class="form-horizontal" name="requirementForm">
            ...
            <div class="col-sm-12">
              <div class="mb-3">
                <div class="row mb-3">
                  <div class="col-sm-3">
                    <label class="col-form-label float-start" for="Name"
                      >Requirement</label
                    >
                  </div>
                  ...
                  <div class="col-sm-9" v-else>
                    <textarea
                      ...
                      v-model="requirement.free_requirement"
                    ></textarea>
                  </div>
                </div>
              </div>
                      ...
                      <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                          <input
                            ...
                            value="1"
                            v-model="requirement.recurrence_pattern"
                          />
                  ...
                  <div class="mb-3">
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        />
                        <strong
                          v-if="requirement.recurrence_pattern == '1'"
                          class="float-start"
                          style="margin-left: 10px"
                          >week(s)</strong
                        >
                        <strong
                          v-else-if="requirement.recurrence_pattern == '2'"
                          class="float-start"
                          style="margin-left: 10px"
                          >month(s)</strong
                        >
                        <strong
                          v-else-if="requirement.recurrence_pattern == '3'"
                          class="float-start"
                          style="margin-left: 10px"
                          >year(s)</strong
                        >
    ...
    "requirement.due_date": {
      handler(newValue) {
        ...
        if (typeof newValue === "string" && newValue.includes("/")) {
          const parsed = moment(newValue, "DD/MM/YYYY", true);
          if (parsed.isValid()) {
            const normalized = parsed.format("YYYY-MM-DD");
            if (normalized !== newValue) {
              this.requirement.due_date = normalized;
              return;
            }
          }
        }

        this.validDate = moment(newValue, "YYYY-MM-DD", true).isValid();
      },
      immediate: true,
    },
  },
