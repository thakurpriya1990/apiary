      ...
      <form class="form-horizontal" name="addContactForm">
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="row">
              <div class="mb-3">
                <label class="col-md-2 col-form-label float-start" for="Name"
                  >Given Name(s):
                </label>
                <div class="col-md-10">
                  <input
            ...
            <div class="row">
              <div class="mb-3">
                <label class="col-md-2 col-form-label float-start" for="Phone"
                  >Phone:
                </label>
                <div class="col-md-10">
                  <input
            ...
            <div class="row">
              <div class="mb-3">
                <label class="col-md-2 col-form-label float-start" for="Mobile"
                  >Mobile:
                </label>
                <div class="col-md-10">
                  <input
            ...
            <div class="row">
              <div class="mb-3">
                <label class="col-md-2 col-form-label float-start" for="Fax"
                  >Fax:
                </label>
                <div class="col-md-10">
                  <input
            ...
            <div class="row">
              <div class="mb-3">
                <label class="col-md-2 col-form-label float-start" for="Email"
                  >Email:
                </label>
                <div class="col-md-10">
                  <input
