...
class Command(BaseCommand):
    ...
    def handle(self, *app_labels, **options):
        ...
        def get_objects(count_only=False):
            ...
            from disturbance.components.proposals.models import SpatialQueryQuestion, CddpQuestionGroup, SpatialQueryLayer
        
            qs1 = CddpQuestionGroup.objects.filter()
            qs2 = SpatialQueryLayer.objects.filter()
            qs3 = SpatialQueryQuestion.objects.filter()

            yield from chain(qs1, qs2, qs3)
