...
class Command(BaseCommand):
    ...
    Excecuted from cron, eg:
        ...
        * * * * * root cd /var/www/disturbance-dev2 && source venv/bin/activate && python manage.py system_maintenance_check >/dev/null 2>&1
    ...
    def handle(self, *args, **options):
        if system_maintenance_can_start():
            ...
            subprocess.Popen(
                settings.SUPERVISOR_STOP_CMD
                + " 2>&1 | tee -a {}".format(self.log_file),
                shell=True,
            )
