...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('apiary', '0029_auto_20200508_1238'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='site_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='site_application_fees', to='apiary.SiteCategory'),
        ),
    ]
