    ...
    methods: {
        updateProposalVersion: async function(proposal_version) {
            ...
            */
            ...
            let url = `/api/history/version/apiary/proposals/Proposal/InternalProposalSerializer/${this.proposalId}/${proposal_version}/`
            ...
            */
            ...
            this.$refs.proposal_apiary.values = Object.assign({}, res.body.data[0]);
